...
public class edredonbtn extends Fragment {
    EditText edtprecio;
    Spinner edtnombre;
    EditText estado;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edredonbtn, container, false);
        setHasOptionsMenu(true);

        edtnombre = (Spinner) view.findViewById(R.id.nombre);
        String[] datos = new String[] {"","Edredon Doble", "Edredon con Plumas", "Edredon Individual", "Edredon Matrimonial", "Edreon King Size"};
