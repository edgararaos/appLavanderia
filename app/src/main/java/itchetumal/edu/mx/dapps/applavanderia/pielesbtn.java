...
public class pielesbtn extends Fragment {
    EditText edtprecio;
    Spinner edtnombre;
    EditText estado;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pielesbtn, container, false);
        setHasOptionsMenu(true);

        edtnombre = (Spinner) view.findViewById(R.id.nombre);
        String[] datos = new String[] {"","Abrigo de Ante", "Abrigo de Cuero", "Bolso de Ante", "Bolso de Cuero", "Calzado en General"};
