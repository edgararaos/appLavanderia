...
public class plancharbtn extends Fragment {
    EditText edtprecio;
    Spinner edtnombre;
    EditText estado;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_plancharbtn, container, false);
        setHasOptionsMenu(true);

        edtnombre = (Spinner) view.findViewById(R.id.nombre);
        String[] datos = new String[] {"","Blusa", "Camisa", "Falda", "Fundas", "Juego de Cama"};
