...
public class prendasespecialesbtn extends Fragment {
    EditText edtprecio;
    Spinner edtnombre;
    EditText estado;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_prendasespecialesbtn, container, false);
        setHasOptionsMenu(true);

        edtnombre = (Spinner) view.findViewById(R.id.nombre);
        String[] datos = new String[]{"", "Vestido de Fiesta", "Abrigo", "Traje", "Chaleco", "Guantes"};
