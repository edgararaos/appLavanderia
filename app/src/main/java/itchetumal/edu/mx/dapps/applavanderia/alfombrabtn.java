...
public class alfombrabtn extends Fragment {
    EditText edtprecio;
    Spinner edtnombre;
    EditText estado;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_alfombrabtn, container, false);
        setHasOptionsMenu(true);

        edtnombre = (Spinner) view.findViewById(R.id.nombre);
        String[] datos = new String[] {"","Sintetica", "Lana", "Piel de Cordero", "Piel de Vca"};
